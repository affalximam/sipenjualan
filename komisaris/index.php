...
<body class="row">
    ...
    <aside class="sidebar d-none d-lg-block col-lg-3 col-xxl-2 pe-0 bg-dark">
        <div class="sidebar-content d-flex flex-column text-bg-dark">
            ...
            <ul class="nav flex-column mb-auto">
                <li class="nav-item">
                <a href="index.html" class="nav-link active text-white border-bottom py-3 ps-4" aria-current="page">
                ...
                <li class="nav-link-dropdown-content d-none">
                    <a href="penjualan-list.html" class="nav-link text-white border-bottom py-2 ps-4 text-white">
                    ...
                    <a href="#" class="nav-link text-white border-bottom py-2 ps-4 text-white">
                ...
                <li>
                    <a href="#" class="nav-link text-white border-bottom py-3 ps-4 text-white">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        <nav class="navbar navbar-expand-none bg-template-blue navbar-dark ps-3 py-0">
            <div class="container-fluid">
                ...
                <a class="navbar-brand d-flex bg-template-blue-1 m-0 px-5 py-4 align-items-center" href="#">
                    ...
                    <p class="ms-3 my-auto pb-0">Kasir</p>
                </a>
                <div class="card account-dropdown text-center d-none border-none">
                    <div class="bg-template-blue pt-3 pb-2">
                        ...
                        <p class="text-white">Kasir - Admin</p>
                    </div>
                    <div class="bg-white py-3">
                        <a href="#" class="btn btn-md bg-transparent text-black border border-secondary-subtle">Logout</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <section class="content p-5 pt-3 bg-secondary-subtle">
            ...
            <h1>HALLO KOMISARIS</h1>
            <h2>Anda Masuk Sebagai KOMISARIS</h2>
        </section>
    </main>
