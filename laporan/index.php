...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - LAPORAN</title>
...
<body class="row">
        ...
        <div class="sidebar-content d-flex flex-column text-bg-dark">
            ...
            <ul class="nav flex-column mb-auto">
                ...
                <?php if ($sessionLayoutType == 1) :?>
                    <li>
                        <a href="../penjualan/penjualan-list.php" class="nav-link text-white border-bottom py-3 ps-4 text-white">
                    ...
                    <li>
                        <a href="../stok/stok-list.php" class="nav-link text-white border-bottom py-3 ps-4 text-white">
                ...
                <?php elseif ($sessionLayoutType == 2) :?>
                    ...
                    <li class="nav-link-dropdown-content d-none">
                        <a href="../penjualan/penjualan-list.php" class="nav-link text-white border-bottom py-2 ps-4 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg"  class="me-2" width="16" height="16" fill="white" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M24 0C10.7 0 0 10.7 0 24S10.7 48 24 48H69.5c3.8 0 7.1 2.7 7.9 6.5l51.6 271c6.5 34 36.2 58.5 70.7 58.5H488c13.3 0 24-10.7 24-24s-10.7-24-24-24H199.7c-11.5 0-21.4-8.2-23.6-19.5L170.7 288H459.2c32.6 0 61.1-21.8 69.5-53.3l41-152.3C576.6 57 557.4 32 531.1 32H360V134.1l23-23c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-64 64c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l23 23V32H120.1C111 12.8 91.6 0 69.5 0H24zM176 512a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm336-48a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z"/></svg>
                            Penjualan
                        </a>
                        <a href="../stok/stok-list.php" class="nav-link text-white border-bottom py-2 ps-4 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg"class="me-2" width="16" height="16" fill="white"  viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M184 48H328c4.4 0 8 3.6 8 8V96H176V56c0-4.4 3.6-8 8-8zm-56 8V96H64C28.7 96 0 124.7 0 160v96H192 320 512V160c0-35.3-28.7-64-64-64H384V56c0-30.9-25.1-56-56-56H184c-30.9 0-56 25.1-56 56zM512 288H320v32c0 17.7-14.3 32-32 32H224c-17.7 0-32-14.3-32-32V288H0V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V288z"/></svg>
                            Stok
                        </a>
                ...
                <?php endif; ?>
                <li>
                    <a href="index.php" class="nav-link active text-white border-bottom py-3 ps-4 text-white">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 bg-secondary-subtle">
            <h1 class="my-2">LAPORAN</h1>

            <form method="POST" class="bg-light px-3 pt-3 border border-secondary-subtle border-4 border-bottom-0 border-end-0 border-start-0">
                <hr>
                <h2 class="fs-4 fw-bold ps-4">PILIH LAPORAN</h2>
                <hr>
                <select class="form-select w-auto mx-2 ms-2" id="entries" aria-label="Show entries" aria-placeholder="PILIH" name="jenis_laporan">
                    <option value="laporan-penjualan">Penjualan</option>
                    <option value="laporan-barang">Barang</option>
                    <option value="laporan-pelanggan">Pelanggan</option>
                </select>
                <hr>
                <h2 class="fs-4 fw-bold ps-4">Tanggal</h2>
                <hr>
                <div class="row ps-4">
                    <button id="datePickerButtonAwal" class="btn btn-lg w-auto border border-secondary rounded-0">
                    ...
                    <input id="datePickerInputAwal" name="tgl_awal" type="text" class="form-control border border-secondary rounded-0 w-25">
                </div>
                <hr>
                <div class="row ps-4">
                    <button id="datePickerButtonAkhir" class="btn btn-lg w-auto border border-secondary rounded-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 448 512">
                            <path d="M128 0c17.7 0 32 14.3 32 32V64H288V32c0-17.7 14.3-32 32-32s32 14.3 32 32V64h48c26.5 0 48 21.5 48 48v48H0V112C0 85.5 21.5 64 48 64H96V32c0-17.7 14.3-32 32-32zM0 192H448V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V192zm64 80v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm128 0v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H208c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H336zM64 400v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H208zm112 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V400c0-8.8-7.2-16-16-16H336c-8.8 0-16 7.2-16 16z"/>
                        </svg>
                    </button>
                    <input id="datePickerInputAkhir" name="tgl_akhir" type="text" class="form-control border border-secondary rounded-0 w-25">
                </div>
                <hr>
                <div class="row pb-4 px-2">
                    <div class="col-6 d-flex justify-content-start">
                        <button type="submit" name="print" class="btn btn-md w-auto bg-secondary-subtle">
