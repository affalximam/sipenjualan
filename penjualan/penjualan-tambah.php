...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - PENJUALAN - TAMBAH</title>
...
<body class="row">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 bg-secondary-subtle">
            <h1 class="my-2">PENJUALAN <span class="fs-4 text-secondary">TAMBAH</span></h1>
            <form class="bg-light p-2 pt-3 pb-5" method="POST">
                <div class="container rounded-2 container-type-1">

                    <div class="row py-3 px-3">
                        <table class="table table-light">
                            <tr class="border-top">
                                <th scope="row" class="col-4">Kode Penjualan</th>
                                <td class="pe-0">:</td>
                                <td class="col-9"><input type="number" class="form-control" name="kd_penjualan"\></td>
                            </tr>
                            <tr>
                                <th scope="row" class="col-4">Nama Pelanggan</th>
                                <td class="pe-0">:</td>
                                <td class="col-6">
                                    <select class="form-select" name="id_pelanggan">
                                        <?php foreach($dataShowPelanggan as $index => $row) { ?>
                                            <option value="<?= htmlspecialchars($row['id_pelanggan']); ?>" <?php if ($id_pelanggan == $row['id_pelanggan']) echo "selected"; ?>>
                                                <?= htmlspecialchars($row['kd_pelanggan']); ?> | 
                            ...
                            <tr>
                                <th scope="row" class="col-4">Kasir</th>
                                <td class="pe-0">:</td>
                                <td class="col-6"><input type="text" class="form-control" name="kasir" value="<?= htmlspecialchars($kasir); ?>"></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="row pb-4 px-2">
                        <div class="col-6 d-flex justify-content-start">
                            <a href="penjualan-list.php" class="btn btn-md btn-primary w-auto bg-template-blue">
                        ...
                        <div class="col-6 d-flex justify-content-end">
                            <button type="submit" name="tambah_penjualan" class="btn btn-md btn-success w-auto">
