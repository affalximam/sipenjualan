...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - PENJUALAN - DETAIL</title>
...
<body class="row">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 bg-secondary-subtle">
            <h1 class="my-2">PENJUALAN <span class="fs-4 text-secondary">DETAIL <?= htmlspecialchars($dataPenjualanDetail['kd_penjualan']) ?></span></h1>
            
            <div class="bg-light p-2 pt-3 pb-5">
                <div class="container rounded-2 container-type-1 pt-3">

                    <div class="row">
                        <div class="col-sm-4">
                            <p class="m-0 fw-bold">Kode Penjualan : <span class="fw-bold"><?= htmlspecialchars($dataPenjualanDetail['kd_penjualan']) ?></span></p>
                            <p class="mt-3 fw-bold">Tanggal Penjualan : <span class="fw-bold"><?= htmlspecialchars(date('M d, Y', strtotime($dataPenjualanDetail['created_at'])))?></span></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="m-0 fw-bold"><?= htmlspecialchars($dataPelanggan['nama_pelanggan']) ?></p>
                            <p class="m-0 fw-normal"><?= htmlspecialchars($dataPelanggan['alamat']) ?></p>
                        </div>
                    </div>
                    ...
                    <div class="row px-3 py-3 text-center">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php foreach ( $dataPenjualanDetailStruk as $key => $value ) : ?>

                                    <?php $kd_penjualan = htmlspecialchars($value['kd_penjualan']);?>
                                    <?php $id_barang = htmlspecialchars($value['id_barang']); ?>
                                    <?php $subtotal_harga = htmlspecialchars($value['subtotal_harga']); ?>

                                    <?php $qtyBarang = getQtybarang($conn, $kd_penjualan, $id_barang); ?>
                                    <?php $subtotalBarang = getSubtotalBarang($subtotal_harga, $qtyBarang); ?>
                                    <?php $nama_barang = getNamaBarang($conn, $id_barang); ?>

                                    <tr>
                                        <td><?= htmlspecialchars($qtyBarang); ?></td>
                                        <td scope="row"><?= htmlspecialchars($nama_barang); ?></td>
                                        <td><?= htmlspecialchars($value['subtotal_harga']); ?></td>
                                        <td><?= htmlspecialchars($subtotalBarang); ?></td>
                                    </tr>
                    ...
                    <div class="row py-3">
                        <div class="col-md-5 offset-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <p class="my-1">
                                        <?php $subtotal = subtotal($conn, $kd_penjualan); ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <p class="my-1">Pajak:</p>
                                </div>
                                <div class="col-6">
                                    <p class="my-1">
                                        <?php $pajak = 0; ?>
                                        <?= htmlspecialchars($pajak); ?>
                                    </p>
                                </div>
                            </div>
                            <hr class="mb-1 mt-0">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <p class="my-1">
                                        <?php $total = total($pajak, $subtotal); ?>
                    ...
                    <div class="row px-3 pb-4">
                        <hr>
                        <a href="./" class="btn btn-md btn-primary w-auto bg-template-blue-3 border-0">
