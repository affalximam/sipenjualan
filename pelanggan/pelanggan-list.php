...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - PELANGGAN - LIST</title>
...
<body class="row">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 bg-secondary-subtle">
            <h1 class="my-2">PELANGGAN <span class="fs-4 text-secondary">INDEX</span></h1>
            <div class="bg-light p-2 pt-3 pb-5 mb-5">
                <div class="container rounded-2 container-type-1">
                    <?php if ($sessionLayoutType == 1) : ?>
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                <a href="pelanggan-tambah.php" class="btn btn-md btn-primary bg-template-blue w-auto border-0 rounded-2 mt-3 me-5">Tambah Pelanggan</a>
                            </div>
                        </div>
                    <?php endif; ?>
                        ...
                        <table class="table table-striped table-bordered mt-3 w-100 text-center">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col-1">Kode Pelanggan</th>
                                    <th scope="col-2">Nama</th>
                                    <th scope="col-1">Tanggal Daftar</th>
                                    <th scope="col-1">Alamat</th>
                                    <th scope="col-1">Kota</th>
                                    <th scope="col-1">No. Telepon</th>
                                    <th scope="col-1">Status</th>
                                    <th scope="col-1">Lihat/Hapus</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if ($showPelangganList == 1) : ?>
                                    <?php foreach ($dataPelangganList as $index => $row) : ?>
                                        <tr>
                                            <th scope="row"><?= htmlspecialchars($start_from + $index + 1 ); ?></th>
                                            <td><?= htmlspecialchars( $row['kd_pelanggan'] ); ?></td>
                                            ...
                                            <td class="d-flex flex-row justify-content-center">
                                                <a href="pelanggan-detail.php?p=<?= htmlspecialchars( $row['kd_pelanggan'] ); ?>" class="btn p-0 m-0 align-content-center text-primary">
                                                ...
                                                <?php if ($sessionLayoutType == 1) : ?>
                                                    <form method="POST">
                                                        <input type="hidden" name="id_pelanggan" value="<?= htmlspecialchars( $row['id_pelanggan'] ); ?>">
                                                        <button type="submit" class="btn p-0 m-0 align-content-center text-primary ms-2" name="hapus_pelanggan">
                                ...
                                <?php else : ?>
                                    <tr>
                                        <th colspan="9" class="py-3">TIDAK ADA PELANGGAN</th>
                                    </tr>
                                <?php endif ?>
                            </tbody>
                        </table>
