...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - HOME</title>
...
<body class="row">
    ...
    <aside class="sidebar d-none d-lg-block col-lg-3 col-xxl-2 pe-0 bg-dark">
        <div class="sidebar-content d-flex flex-column text-bg-dark">
            ...
            <div class="nav flex-column mb-auto">
                <li class="nav-item">
                <a href="index.php" class="nav-link active text-white border-bottom py-3 ps-4" aria-current="page">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-3 bg-secondary-subtle">
            <h1 class="mb-3">HOME <span class="fs-4 text-secondary">HALAMAN UTAMA</span></h1>
            <h1>HALLO <?= htmlspecialchars($sessionUser); ?></h1>
            <h2>Anda Masuk Sebagai <?= htmlspecialchars($sessionUser); ?></h2>
        </section>
    </main>
