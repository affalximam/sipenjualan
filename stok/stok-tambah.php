...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - STOK - TAMBAH</title>
...
<body class="row">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 bg-secondary-subtle">
            <h1 class="my-2">STOK <span class="fs-4 text-secondary">TAMBAH</span></h1>
            <form class="bg-light px-3 pt-3" method="POST">
                <div class="row py-3 px-3">
                    <table class="table table-light">
                        <tr class="border-top">
                            ...
                            <td class="col-6">
                                <div class="d-flex">
                                    ...
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="text" class="form-control w-100 border border-danger" name="kd_barang" required>
                                    <?php } else  { ?>
                                        <input type="text" class="form-control w-100" name="kd_barang" required>
                                    <?php } ?>
                                </td>
                            </div>
                        </tr>
                        <tr class="border-top">
                            ...
                            <td class="col-6">
                                <div class="d-flex">
                                    <label class="pe-2">:</label>
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="text" class="form-control w-100" name="nama_barang" required value="<?= htmlspecialchars($nama_barang); ?>">
                                    <?php } else { ?>
                                        <input type="text" class="form-control w-100" name="nama_barang" required>
                                    <?php } ?>
                                </td>
                            </f>
                        </tr>
                        <tr class="border-top">
                            ...
                            <td class="col-6">
                                <div class="d-flex">
                                    <label class="pe-2">:</label>
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="number" class="form-control w-100" name="harga_barang" required value="<?= htmlspecialchars($harga_barang); ?>">
                                    <?php } else { ?>
                                        <input type="number" class="form-control w-100" name="harga_barang" required>
                                    <?php } ?>
                                </td>
                            </div>
                        </tr>
                        <tr class="border-top">
                            ...
                            <td class="col-6">
                                <div class="d-flex">
                                    <label class="pe-2">:</label>
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="text" class="form-control w-100" name="satuan" required value="<?= htmlspecialchars($satuan); ?>">
                                    <?php } else { ?>
                                        <input type="text" class="form-control w-100" name="satuan" required>
                                    <?php } ?>
                                </td>
                            </div>
                        </tr>
                        <tr class="border-top">
                            <td class="col-3">
                                <p class="fw-bold">Jenis</p>
                            </td>
                            <td class="col-6">
                                <div class="d-flex">
                                    <label class="pe-2">:</label>
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="text" class="form-control w-100" name="jenis_barang" required value="<?= htmlspecialchars($jenis_barang); ?>">
                                    <?php } else { ?>
                                        <input type="text" class="form-control w-100" name="jenis_barang" required>
                                    <?php } ?>
                                </td>
                            </div>
                        </tr>
                        <tr class="border-top">
                            <td class="col-3">
                                <p class="fw-bold">Pemasok</p>
                            </td>
                            <td class="col-6">
                                <div class="d-flex">
                                    <label class="pe-2">:</label>
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="text" class="form-control w-100" name="pemasok" required value="<?= htmlspecialchars($pemasok); ?>">
                                    <?php } else { ?>
                                        <input type="text" class="form-control w-100" name="pemasok" required>
                                    <?php } ?>
                                </td>
                            </div>
                        </tr>
                        <tr class="border-top">
                            ...
                            <td class="col-6">
                                <div class="d-flex">
                                    <label class="pe-2">:</label>
                                    <?php if (isset($_POST['tambah_barang'])) { ?>
                                        <input type="number" class="form-control w-100" name="qty" required value="<?= htmlspecialchars($qty); ?>">
                                    <?php } else { ?>
                                        <input type="number" class="form-control w-100" name="qty" required>
                                    <?php } ?>
                                </td>
                            </div>
                        </tr>
                ...
                <div class="row pb-4 px-2">
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <button class="btn btn-md btn-success w-auto" type="submit" name="tambah_barang">
