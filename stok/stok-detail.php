...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - STOK - DETAIL STOK</title>
...
<body class="row">
    ...
    <aside class="sidebar d-none d-lg-block col-lg-3 col-xxl-2 pe-0 bg-dark">
        <div class="sidebar-content d-flex flex-column text-bg-dark">
            ...
            <ul class="nav flex-column mb-auto">
                <li class="nav-item">
                    <a href="../index.php" class="nav-link text-white border-bottom py-3 ps-4" aria-current="page">
                ...
                <?php if ($sessionLayoutType == 1) : ?>
                    ...
                    <li>
                        <a href="../stok/" class="active nav-link text-white border-bottom py-3 ps-4 text-white">
                ...
                <?php elseif( $sessionLayoutType == 2) : ?>
                    ...
                    <li class="nav-link-dropdown-content d-none">
                        ...
                        <a href="../stok/" class="active nav-link text-white border-bottom py-2 ps-4 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg"class="me-2" width="16" height="16" fill="white"  viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M184 48H328c4.4 0 8 3.6 8 8V96H176V56c0-4.4 3.6-8 8-8zm-56 8V96H64C28.7 96 0 124.7 0 160v96H192 320 512V160c0-35.3-28.7-64-64-64H384V56c0-30.9-25.1-56-56-56H184c-30.9 0-56 25.1-56 56zM512 288H320v32c0 17.7-14.3 32-32 32H224c-17.7 0-32-14.3-32-32V288H0V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V288z"/></svg>
                            Stok
                        </a>
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 bg-secondary-subtle">
            <h1 class="my-2">STOK <span class="fs-4 text-secondary"><?= htmlspecialchars($dataBarangDetail['nama_barang']); ?></span></h1>
            <div class="bg-light p-2 pt-3 pb-5">
                <div class="container rounded-2 container-type-1">

                    <div class="row">
                        <p class="fs-5 m-0 fw-bold">KODE BARANG : <span class="fw-normal"><?= htmlspecialchars($dataBarangDetail['kd_barang']); ?></span></p>
                        <p class="fs-5 m-0 fw-bold">NAMA BARANG : <span class="fw-normal"><?= htmlspecialchars($dataBarangDetail['nama_barang']); ?></span></p>
                        <p class="fs-5 m-0 fw-bold">JENIA BARANG : <span class="fw-normal"><?= htmlspecialchars($dataBarangDetail['jenis_barang']); ?></span></p>
                        <p class="fs-5 m-0 fw-bold">SATUAN : <span class="fw-normal"><?= htmlspecialchars($dataBarangDetail['satuan']); ?></span></p>
                        <p class="fs-5 m-0 fw-bold">PEMASOK : <span class="fw-normal"><?= htmlspecialchars($dataBarangDetail['pemasok']); ?></span></p>
                    </div>

                    
                    <?php if ($sessionLayoutType == 1) : ?>
                        <div class="row px-4">
                            <div class="container rounded-2 container-type-1 pb-2">
                                <form class="row py-2 px-3" method="POST">
                                    <h3>Tambah Stok</h3>
                                    <hr>
                                    <input type="number" class="form-control mb-3" name="jumlah_barang" required>
                                    <input type="hidden" name="kd_barang" value="<?= htmlspecialchars($dataBarangDetail['kd_barang']); ?>">
                                    <input type="hidden" name="id_barang" value="<?= htmlspecialchars($dataBarangDetail['id']); ?>">
                                    <hr>
                                    <button type="submit" name="tambah_stok" class="btn btn-md btn-primary w-100 bg-template-blue-3 border-0">
                    ...
                    <div class="row px-3 py-3 text-center">
                        <h3>Log Stok</h3>
                        <?php if($showDataLog == 1) { ?>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col-4">NO</th>
                                        <th scope="col-4">Tanggal</th>
                                        <th scope="col-4">Qty</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php foreach($dataLog as $index => $rowlog) :?>
                                    <tr>
                                        <td scope="row"><?= htmlspecialchars($index + 1); ?></td>
                                        <td><?= htmlspecialchars($rowlog['restock_at']); ?></td>
                                        <td><?= htmlspecialchars($rowlog['jumlah_stok']); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                <tr>
                                    </tr>
                        ...
                        <?php } else { ?>
                            <h3 class="w-100 mt-3">TIDAK ADA LOG</h3>
                        <?php } ?>
                    </div>

                    <div class="row pb-4 px-2">
                        <div class="col-6 d-flex justify-content-start">
                            <a class="btn btn-md btn-primary w-auto bg-template-blue" href="stok-list.php">
                        ...
                        <?php if ($sessionLayoutType == 1) : ?>
                            <div class="col-6 d-flex justify-content-end">
                                <form method="POST">
                                    <?php if($showDataLog == 1) { ?>
                                        <input type="hidden" name="id_barang" value="<?= htmlspecialchars($dataBarangDetail['id']); ?>">
                                        <button type="submit" name="hapus_stok_terakhir" class="btn btn-md btn-danger w-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                                                <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/>
                                            </svg>
                                            HAPUS STOK TERAKHIR
                                    ...
                                    <?php } else { ?>
                                        <button class="btn btn-md btn-danger w-auto" disabled>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                                                <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z"/>
                                            </svg>
                                            HAPUS STOK TERAKHIR
