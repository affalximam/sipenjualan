...
<head>
    ...
    <title><?= htmlspecialchars($sessionUser); ?> - STOK - LIST</title>
...
<body class="row">
        ...
        <div class="sidebar-content d-flex flex-column text-bg-dark">
            ...
            <ul class="nav flex-column mb-auto">
                ...
                <?php if ($sessionLayoutType == 1) : ?>
                    ...
                    <li>
                        <a href="../stok/" class="nav-link active text-white border-bottom py-3 ps-4 text-white">
    ...
    <main class="main col-12 col-md-12 col-lg-9 col-xxl-10 p-0">
        ...
        <section class="content p-5 pt-1 pb-5 bg-secondary-subtle">
            <h1 class="my-2">STOK <span class="fs-4 text-secondary">LIST</span></h1>
            <div class="bg-light p-2 pt-3 pb-5 mb-5">
                <div class="container rounded-2 container-type-1">

                    <?php if ($sessionLayoutType == 1) : ?>
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                <a href="stok-tambah.php" class="btn btn-md btn-primary bg-template-blue w-auto border-0 rounded-2 mt-3 me-5">Tambah Stok</a>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-6 d-flex justify-content-xl-end">
                            <form class="d-flex" method="GET" action="?entries=<?= htmlspecialchars($entries); ?>">
                                ...
                                <input class="form-control me-2" id="search" type="search" placeholder="Search" aria-label="Search" name="s">
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="row row-table ms-2 pe-3">
                        <table class="table table-striped table-bordered mt-3 w-100 text-center">
                            ...
                            <tbody>
                                <?php if ($showBarang == 1) { ?>
                                    <?php foreach($databarangList as $index => $row ) { ?>
                                        <?php $id_barang = htmlspecialchars($row['id']); $totalQty = getTotalQuantity($conn, $id_barang); ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars( $totalQty ); ?></td>
                                            <td class="d-flex flex-row justify-content-center">
                                                <a href="stok-detail.php?b=<?= htmlspecialchars( $row['kd_barang'] ); ?>" class="btn p-0 m-0 align-content-center text-primary">
                                                ...
                                                <?php if ($sessionLayoutType == 1) : ?>
                                                    <form method="POST">
                                                        ...
                                                        <button href="#" class="btn p-0 m-0 align-content-center text-primary ms-2" name="hapus_barang">
                                ...
                                <?php } else { ?>
                                    <tr>
                                        <th colspan="9" class="py-4">TIDAK ADA DATA</th>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
